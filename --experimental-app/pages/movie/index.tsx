...
const MovieDetailByQuery: React.FC = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-netflix-black text-white">
        <div className="text-center">
          <h2 className="text-2xl font-semibold">No movie selected</h2>
          <p className="mt-2 text-gray-400">Open a movie from the home page to view details.</p>
        </div>
      </div>
    );
  }
...
export default MovieDetailByQuery;
